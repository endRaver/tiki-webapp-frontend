  ...
  return (
    <div className="md:hidden">
      <div className="flex justify-around gap-5 bg-[#1BA8FF] p-2.5 align-middle">
        ...
        <div className="flex bg-[#FFFFFF] p-1">
      ...
      <div className="flex justify-center">
        <div className="mx-1 mt-5 flex gap-2 rounded-2xl bg-[#FFE880] px-12 py-4">
          <img src={day30} alt="" />
          <span className="font-bold">đổi ý & miễn phí trả hàng</span>
          <img src={right} alt="" />
        </div>
      </div>
      <div className="h-2 bg-[#EFEFEF]"></div>
      <div className="py-4">
