import { header_img_Cart } from "@/assets/icons/header_icons";
...
const Profile = () => {
  ...
  return (
    <div className="flex min-h-screen bg-gray-100 px-15">
      {/* Sidebar */}
      <aside className="w-1/5 p-6">
        <div className="flex items-center gap-x-2">
          <div>
            <img
              ...
              src="https://salt.tikicdn.com/cache/280x280/ts/product/15/bd/41/e5dafc6155363ddfdf3d9c39247f5106.jpg"
              alt=""
            />
          </div>
          <div>
        ...
        <nav className="mt-4 space-y-2">
          <p className="flex cursor-pointer text-gray-500">
            <img src={header_img_Cart} alt="" />
            Thông tin tài khoản
          </p>
          <p className="flex cursor-pointer text-gray-500">
            <img src={header_img_Cart} alt="" />
      ...
      <main className="flex-1 p-6">
        ...
        <div className="flex gap-4">
          ...
          <div className="w-1/3">
            ...
            <div className="h-35 rounded-lg bg-white p-6">
              <p className="mb-1 font-bold">VŨ ANH TÚ</p>
              <p className="mb-1 text-gray-500">
                Số 17 Duy Tân, Phường Dịch Vọng, Cầu Giấy, Hà Nội, Việt Nam
              </p>
              <p className="mb-1 text-gray-500">Điện thoại: 0942438693</p>
            </div>
          </div>
          ...
          <div className="w-1/3">
            ...
            <div className="h-35 rounded-lg bg-white p-6">
              <p className="mb-1 flex text-gray-500">
                {/* <img className="mr-1" src={checkout_delivery} alt=""></img>Giao
                Siêu Tốc */}
                {/* TODO: Add icon */}
              </p>
              <p className="mb-1 text-gray-500">Giao thứ 6, trước 13h, 28/03</p>
              <p className="mb-1 text-gray-500">Miễn phí vận chuyển</p>
            </div>
          </div>
          <div className="w-1/3">
        ...
        <div className="mt-4 rounded-lg bg-white p-6 shadow-md">
          ...
          {/* Product Row */}
          <div className="grid grid-cols-6 border-b py-4">
          ...
          <div className="grid justify-items-end">
            <div className="grid w-1/3 gap-2 text-sm text-gray-600">
              {/* Order Summary Items */}
              ...
              <div className="flex justify-end">
                <button className="w-30 rounded-sm bg-yellow-300 py-2 text-black hover:bg-yellow-200">
                  Hủy đơn hàng
                </button>
              </div>
            </div>
        ...
        <div className="mt-8 flex items-center gap-4">
          ...
          <div>
            <button className="cursor-pointer rounded-sm bg-yellow-300 px-8 py-2 font-bold hover:bg-yellow-200">
              Theo dõi đơn hàng
            </button>
          </div>
        </div>
