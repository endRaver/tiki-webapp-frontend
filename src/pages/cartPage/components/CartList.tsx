...
const initialCartItems = [
  // Nhà sách Fahasa (5 sản phẩm)
  {
    ...
    seller: {
      ...
      discount: 'FREESHIP XTRA FREESHIP 15K đơn từ 45K, FREESHIP 70K đơn từ 100K',
    },
  ...
  },
  {
    ...
    image: 'https://salt.tikicdn.com/ts/product/c9/e4/18/a9cfc425fa590c453f20307229804bb3.jpg',
  ...
  },
  {
    ...
    image: 'https://salt.tikicdn.com/ts/product/22/cb/a9/524a27dcd45e8a13ae6eecb3dfacba7c.jpg',
  ...
  },
  {
    ...
    image: 'https://salt.tikicdn.com/cache/w1200/ts/product/83/30/87/737846efdb9f28f0f51352cacf9225c5.jpg',
  ...
  },
  {
    ...
    image: 'https://salt.tikicdn.com/cache/280x280/ts/product/55/00/f0/c7f56cd8e154a62ef6d0cc2abbfa4dcb.jpg',
    name: 'Dám Bị Ghét',
    originalPrice: 96000,
  ...
  // 1980 Books (4 sản phẩm)
  {
    ...
    image: 'https://cdn1.fahasa.com/media/flashmagazine/images/page_images/nhung_nguoi_khon_kho_tap_2/2020_06_25_13_57_26_1-390x510.jpg',
  ...
  },
  {
    ...
    image: 'https://salt.tikicdn.com/ts/product/38/0a/10/bd9600254bf047d6e9081b1144768dec.jpg',
    name: 'Tôi Tự Học',
    originalPrice: 86000,
  ...
  },
  {
    ...
    image: 'https://salt.tikicdn.com/cache/280x280/ts/product/d3/48/5b/94952b0d1780bf24250fd077a5c8927c.jpg',
...
const CartList: React.FC<CartListProps> = ({
  ...
  const groupedItems = items.reduce((acc, item) => {
    ...
    return acc;
  }, {} as { [key: string]: { seller: { name: string; link: string; discount: string }; items: typeof initialCartItems } });
  ...
  return (
    <div className="bg-[#ffffff] "> {/* Add padding-top to account for the fixed header */}
      {items.length === 0 ? (
        <p className="p-4 text-center text-sm space-x-4">Giỏ hàng trống</p>
      ) : (
        <>
          {Object.entries(groupedItems).map(([sellerName, { seller, items }]) => {
            const allItemsInSellerSelected = items.every((item) => item.isSelected);
            return (
              <div key={sellerName} className="mb-4">
                <div className="py-4 px-4">
                  <div className="flex items-center space-x-2">
                    <input
                      type="checkbox"
                      className="h-[18px] w-[18px] border-1 border-[#c4c4cf] hover:border-[#0b74e5] appearance-none rounded-sm cursor-pointer checked:bg-[#0b74e5] transition-colors duration-200"
                    ...
                    <a
                      href={seller.link}
                      className="text-[rgb(56,56,61)] font-medium text-[14px] flex items-center"
                    >
                      {sellerName}
                      <img
