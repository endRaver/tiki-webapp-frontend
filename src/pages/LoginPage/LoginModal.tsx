    ...
    return (
        <div>
            <div className="my-[20px]">
                <p className="text-2xl font-medium mb-[10px]">Đăng nhập bằng email</p>
            ...
            <form action="" className="flex-col flex">
                ...
                <div className="w-full mb-[15px] border-b border-gray-200 flex justify-between">
                    <input className="w-full focus:outline-none" type="password" name="password" id="password" placeholder="Mật khẩu" />
                    <span className="inline text-blue-500">Hiện</span>
                </div>
                <button className="py-[13px] mt-[26px] mb-[10px] bg-red-500 hover:bg-red-400 rounded-sm text-white font-medium">Đăng nhập</button>
            </form> 
        </div>
    )
}
